...
const LoginPage = () => {
    ...
    return (
        <div className="absolute top-0 z-20 h-full px-10 gap-10 box-border flex flex-col items-center justify-center  bg-blue-100">
            <form onSubmit={(e) => handleSubmit(e)} className="w-full flex-col flex gap-10">
